package org.bitcoins.dlc.wallet.networking
...
import org.bitcoins.dlc.wallet.networking.peer.PeerMessageReceiver._
import org.bitcoins.dlc.wallet.networking.peer._
...
/** This actor is responsible for creating a connection,
  ...
  * [[org.bitcoins.dlc.wallet.networking.peer.PeerMessageSender PeerMessageSender]]
  ...
  *                               a [[org.bitcoins.dlc.wallet.networking.peer.PeerMessageSender]]
  */
  ...
  private[bitcoins] def parseIndividualMessages(
    ...
    def loop(
      ...
      if (remainingBytes.length <= 0) {
        ...
        Try(LnMessage.fromBytes(remainingBytes)) match {
          case Failure(_) =>
